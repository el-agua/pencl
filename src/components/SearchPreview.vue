  ...
  <div  id="rounded-cardC" @mouseover="showChev=true" @mouseleave="showChev=false" class="card">
              <div class="card-content">
                <router-link :to="myLink">
                  ...
                  <p class="is-size-6 has-text-dark">{{`Created by: ${creator}` }}</p>
             ...
             <footer  class="card-footer is-cool">
              <div class="card-footer-item">
                 <div  class="icon is-small">
                   ...
                   <i v-show="showChev == true" class="mdi mdi-24px mdi-chevron-down"></i>
                   </transition>
                  </div>
              </div>
            </footer>
...
export default {
    name: 'SearchPreview',
    props:[
        'title', 'datec','link', 'priv', 'creator', 'numOfPartic'
    ],
    data(){
        return{
          myLink: '/view/'+String(this.link),
          showChev: false
        }
    },
    methods:{
