<template>
  <section class="section">
    <div class="container">
      ...
      <EditQuestion
        @questionDelete="deleteProblem"
        @editSend="appendProblems"
        ref="questionModel"
  ...
  mounted: function() {
    this.$nextTick(function() {
      if (this.user.username != null) {
        questionService
          .getEditSet(this.user.username, this.$route.params.id)
          .then((q) => {
