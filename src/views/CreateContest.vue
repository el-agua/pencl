        ...
        <div class="box">
          <div class="container">
            ...
            <div class="columns is-centered">
              <div class="column is-12">
                <b-field
                  ...
                  :type="{
                    'is-danger':
                      $v.duration.integer == false || errors.duration == false,
                  }"
                  :message="{
            ...
            <div class="columns is-centered">
              <div class="column is-12">
                <b-field
                  ...
                  :type="{
                    'is-danger':
                      $v.score0.decimal == false || errors.score0 == false,
                  }"
                  :message="{
                ...
                >
                  <b-input
                    ...
                    @blur="score0Check"
                    v-model="score0"
                    placeholder="Points Per Correct Answer"
                    type="text"
                  >
                  </b-input>
                </b-field>
            ...
            <div class="columns is-centered">
              <div class="column is-12">
                <b-field
                  label="Points Per Blank Answer"
                  :type="{
                    'is-danger':
                      $v.score1.decimal == false || errors.score1 == false,
                  }"
                  :message="{
                    'Please enter a number...':
                ...
                >
                  <b-input
                    ...
                    @blur="score1Check"
                    v-model="score1"
                    placeholder="Points Per Blank Answer"
                    type="text"
                  >
                  </b-input>
                </b-field>
            ...
            <div class="columns is-centered">
              <div class="column is-12">
                <b-field
                  ...
                  :type="{
                    'is-danger':
                      $v.score2.decimal == false || errors.score2 == false,
                  }"
                  :message="{
                    'Please enter a number...':
            ...
            <div class="columns is-centered has-text-centered">
              <div class="is-size-6">
                Warning: Using public sets may decrease the quality of your
                test.
              </div>
            </div>
            <section class="section">
              <div class="columns is-centered has-text-centered">
                <b-field>
                  <b-checkbox size="is-medium" v-model="linkOnly"
                    >Contest is only accessible by link.</b-checkbox
                  >
                </b-field>
              </div>
            </section>
    ...
    submitForm() {
      ...
      if (this.$v.$invalid) {
        ...
        if (
          ...
          console.log(contest);
          contestService.addContest(contest).then(() => {
