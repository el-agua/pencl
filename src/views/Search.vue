<template>
  <section class="section">
    ...
    <div class="container">
      <div
        v-if="(sets.length == 0) & (searched == true)"
        class="columns is-centered"
      >
        <div id="high" class="is-size-5">
          Uh oh! No problem sets match your search!
        </div>
      </div>
...
export default {
  ...
  methods: {
    search() {
      questionService.searchProblems(this.param).then((problems) => {
        this.sets = problems;
        this.searched = true;
      });
    },
